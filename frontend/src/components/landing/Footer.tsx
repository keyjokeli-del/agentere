...
import { Stethoscope, MapPin, Phone, Clock, AlertTriangle, LayoutDashboard, Heart } from 'lucide-react';

export default function Footer() {
  return (
    <footer 
      aria-label="Pie de página e información institucional"
      className="border-t border-white/10 bg-slate-950 text-slate-400 text-xs pt-14 pb-12"
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-5 space-y-4">
            <div className="flex items-center gap-2.5">
              <div className="w-8 h-8 rounded-xl bg-sapphire-900 border border-cyan-bright/40 flex items-center justify-center text-cyan-bright">
            ...
            <div className="pt-2">
              <Link 
                href="/dashboard"
                className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white/5 hover:bg-white/10 text-slate-300 hover:text-white border border-white/10 transition-colors font-medium text-xs"
              >
                <LayoutDashboard className="w-3.5 h-3.5 text-teal-400" />
                <span>Acceso Personal Clínico (Dashboard)</span>
              </Link>
            </div>
          </div>
          ...
          <div className="md:col-span-4 space-y-3">
            ...
            <ul className="space-y-2.5 text-slate-300">
              ...
              <li className="flex items-center gap-2">
                ...
                <span>+54 9 11 4567-8900 (Urgencias 24/7)</span>
              </li>
              <li className="flex items-center gap-2">
          ...
          <div className="md:col-span-3 space-y-3">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/dashboard" className="hover:text-cyan-bright transition-colors">Simulador Multicanal</Link>
              </li>
            </ul>
          </div>
